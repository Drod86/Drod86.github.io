...
const NAV = (0, _utilsMjs.grab)("nav");
const ITEMS = Object.values(NAV.children);
const MENU = ITEMS.pop().children[1];
const toggleMenu = ()=>{
    if (NAV.classList.length > 1) {
        (0, _utilsMjs.stopListenAll)(ITEMS, "click", toggleMenu);
        NAV.classList.remove("open");
    } else {
        NAV.classList.add("open");
        (0, _utilsMjs.onClickAll)(ITEMS, toggleMenu);
    }
};
(0, _utilsMjs.onClick)(MENU, toggleMenu);

},{"./utils/utils.mjs":"gMXMZ"}],"gMXMZ":[function(require,module,exports) {
// DOM
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "grab", ()=>grab);
parcelHelpers.export(exports, "grabAll", ()=>grabAll);
parcelHelpers.export(exports, "render", ()=>render);
parcelHelpers.export(exports, "onLoad", ()=>onLoad);
parcelHelpers.export(exports, "onLoadAll", ()=>onLoadAll);
parcelHelpers.export(exports, "onClick", ()=>onClick);
parcelHelpers.export(exports, "onClickAll", ()=>onClickAll);
parcelHelpers.export(exports, "listen", ()=>listen);
parcelHelpers.export(exports, "listenAll", ()=>listenAll);
parcelHelpers.export(exports, "stopListen", ()=>stopListen);
parcelHelpers.export(exports, "stopListenAll", ()=>stopListenAll);
parcelHelpers.export(exports, "checkStyle", ()=>checkStyle);
...
},{}]},["hklly","bNKaB"], "bNKaB", "parcelRequireec45")
